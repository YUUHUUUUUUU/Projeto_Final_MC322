...
class UserManagerTest {
    ...
    void testSignIn_Success() {
        ...
        assertDoesNotThrow(() -> userManager.signIn("Rafael", "rafael1", "ValidP@ss123"));
        assertDoesNotThrow(() -> userManager.signIn("Rafaell", "rafael12", "ValidP@ss123"));
        assertDoesNotThrow(() -> userManager.signIn("Rafaelll", "rafael13", "ValidP@ss123"));
        assertDoesNotThrow(() -> userManager.signIn("Rafaellll", "rafael14", "ValidP@ss123"));
